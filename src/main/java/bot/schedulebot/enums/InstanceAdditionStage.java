...
public enum InstanceAdditionStage {
    ...
    GROUP_START,
    GROUP_NAME,
    TASK_START, TASK_NAME, TASK_SUBJECT,
    TASK_DESCRIPTION, TASK_DEADLINE,
    GROUP_JOIN,
    ...
    ANNOUNCEMENT_START, NOTIFICATION_START, NOTIFICATION_TEXT, NOTIFICATION_DATE, NOTIFICATION_TIME, NOTIFICATION_FREQUENCY, NOTIFICATION_TITLE, NONE
}
